SRCS =  ./mandatory/push.c ./mandatory/rotate.c ./mandatory/swaps.c ./mandatory/reverse_rotate.c  ./mandatory/stack_utils.c  ./mandatory/small_sort.c ./mandatory/utils.c  ./mandatory/push_swap.c ./mandatory/tools_stack.c ./mandatory/big_sort.c ./mandatory/range_tools.c ./mandatory/atoi.c ./mandatory/tools.c
